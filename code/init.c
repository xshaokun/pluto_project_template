...
/*!
  ...
  \image html hd_jet.jpg "Pressure (left) and density (right) maps for
  configuration #01 at t=15" \author A. Mignone (mignone@to.infn.it) \date   Feb
  25, 2019
*/
/* ///////////////////////////////////////////////////////////////////// */
#include "pluto.h"
 ...
 *********************************************************************** */
{
  ...
  cs =
      sqrt(vj[PRS] / vj[RHO]); /* -- For simplicity, isothermal cs is used -- */
